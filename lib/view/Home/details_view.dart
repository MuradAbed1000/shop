  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: Column(children: [
        Container(width: MediaQuery.of(context).size.width,height: 250, child: Image.network(model!.image,fit: BoxFit.fill,)),
        SizedBox(height: 15,),
        Expanded(
              ...
              children: [
                ...
                Row(
                  ...
                  SizedBox(height: 15,),
                   ...
                   CustomText(text:'Details' ,fontsize: 18,fontWeight: FontWeight.bold,),
                   SizedBox(height: 20,),
                   CustomText(text: model!.descripation,fontsize: 18,spaceLine: 2.5,),
...
Column(
  ...
  children: [
    ...
    SizedBox(height: 10,),
    CustomText(text:'\$${ model!.price}',color: primaryColor,fontsize: 18,),
  ],
)
         , 
          Container(
